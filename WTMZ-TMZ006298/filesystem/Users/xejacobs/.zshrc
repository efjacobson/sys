...
export PATH=/Users/xejacobs/dev/googlesource/chromium/depot_tools:$PATH
export PATH=/Users/xejacobs/bin:$PATH

function run_with_last_arg() {
  private last_arg=""
  for addr in $(echo "$(history -1)" | tr " " "\n"); do
    last_arg="$addr"
  done

  private full_command=""
  for arg in "$@"; do
    full_command="$full_command $arg"
  done

  eval "$full_command $last_arg"
}
